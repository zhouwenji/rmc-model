...
RUC-MESSAGEix-China（简称RMC模型）是基于开源建模框架MESSAGEix（[IIASA ECEProgramme,2020](./references.md)）开发的中国省级尺度能源-经济-环境（E3）综合评估模型，由中国人民大学应用经济学院周文戟教授（邮箱：zhouwenji@ruc.edu.cn）团队和华东理工大学任宏涛教授（邮箱：ren@ecust.edu.cn）联合开发和维护。
